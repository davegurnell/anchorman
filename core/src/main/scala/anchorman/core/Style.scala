...
object ParaStyle {
  ...
  val default = ParaStyle(
    spacing = Some(ParaSpacing(before = 0.pt, after = 6.pt))
  )
  val heading1 = ParaStyle(
    spacing = Some(ParaSpacing(before = 24.pt, after = 6.pt))
  )
  val heading2 = ParaStyle(
    spacing = Some(ParaSpacing(before = 12.pt, after = 6.pt))
  )
  val heading3 = ParaStyle(
    spacing = Some(ParaSpacing(before = 6.pt, after = 6.pt))
  )
}
